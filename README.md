...
I expect to make a video tutorial for this Daily Pixel Mike project in the near future, in the same style as my [Inky Doodle](https://github.com/amamenko/inky-doodle) tutorial (which can be found on YouTube [here](https://www.youtube.com/watch?v=XzyYi_yv86A)), but hopefully quite a bit shorter.
